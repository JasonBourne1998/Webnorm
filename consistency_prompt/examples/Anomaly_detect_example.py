...
import sys
sys.path.append("../")
from gptchecker.tester import Tester
        ...
        if (method_name and class_name) and "gettoken" not in method_name.lower():
            ...
            for dataflow, constraint in data_constraints.items():
                ...
                if class_name + "." + method_name in follow:
                    ...
                    # print(pre_log,pre_class_name, pre_method_name)
                    if pre_method_name:
                        logset = []
                        for lg in pre_log:
                            logset.append(lg)
...
def find_last_log(after_log,pre_classname,txt_file_path):
    ...
    for i in range(idx,0,-1):
        log = logs[i]
        # print('12',log,class_name,method_name)
        if class_name in log and method_name in log:
            if "queryOrdersForRefresh" in method_name:
                ...
                for j in range(idx,0,-1):
                    other_log = logs[j]
                    # print("other_log",other_mehthod,other_class)
...
if __name__ == "__main__":
    ...
    txt_file_path = '/home/yifannus2023/TamperLogPrompt/consistency_prompt/examples/Cancel_attack.txt'
    data_constraints = '/home/yifannus2023/TamperLogPrompt/data_constraints.json'
    commonsense_constraints = '/home/yifannus2023/TamperLogPrompt/commonsense_constraints.json'
    trigger_constraints = "/home/yifannus2023/TamperLogPrompt/trigger_constraints.json"
    trainticket_class = "/home/yifannus2023/TamperLogPrompt/Event_graph/trainticket_class_def.json"
