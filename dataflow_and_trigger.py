...
def main():
    ...
    for disp_match in unique_matches:
        ...
        if disp_match in [ 'other.service.OrderOtherServiceImpl.queryOrdersForRefresh > inside_payment.service.InsidePaymentServiceImpl.pay', 'other.service.OrderOtherServiceImpl.queryOrdersForRefresh > consign.service.ConsignServiceImpl.updateConsignRecord'] :
            try:
                for seeds_name, sequence in common_sequences.items(): 
